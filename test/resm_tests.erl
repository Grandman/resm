...
list_test_() ->
  {
    ...
    [
      {
        "List",
        ?_assertEqual({ok, {resources, #{allocated => #{}, deallocated => [r1, r2, r3, r4, r5]}}},
                      resm:list())
      }
    ]
  }.
    ...
    [
      {
        ...
        [
          {
            "Return resource",
             ?_assertEqual({ok, {resource, r1}}, resm:allocate('Alice'))
          },
          {
            "Resource should allocated",
            ?_assertEqual({ok,{resources, #{allocated => #{r1 => 'Alice'}, deallocated => []}}},
                          resm:list())
          }
        ]
      },
    ...
    [
      {
        ...
        [
          {
            "Return ok",
             ?_assertEqual(ok, resm:deallocate(r1))
          },
          {
            "Resource should be deallocated",
            ?_assertEqual({ok, {resources, #{allocated => #{}, deallocated => [r1]}}}, resm:list())
          }
        ]
      },
      {
    ...
    [
      {
        ...
        ?_assertEqual({ok, {resources, [r1]}}, resm:list('Alice'))
      },
      {
        "Return empty if user not have allocated",
        ?_assertEqual({ok, {resources, []}}, resm:list('Bob'))
      }
    ]
  }.
reset_test_() ->
    ...
    [
      {
        ...
        [
          ...
          },
          {
            ...
            ?_assertEqual({ok, {resources, #{allocated => #{}, deallocated => [r2, r1]}}},
                          resm:list())
          }
        ]
      }
